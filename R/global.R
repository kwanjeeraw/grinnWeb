...
##function to format result network to cytoscapeJS input format
##https://github.com/cytoscape/r-cytoscape.js/blob/master/cytoscapeJsSimpleNetwork.R
## modify the R function from r-cytoscape.js, to return json output for generating Cytoscape.js network 
